...
local function UpdateCityWorkingHexes( city )
	...
	EventsClearHexHighlightStyle( "WorkedForcedFill" )
	EventsClearHexHighlightStyle( "WorkedForcedOutline" )
			...
			if city:IsWorkingPlot( plot ) then
				...
				if cityPlotIndex == 0 then
					...
					if notInStrategicView then
						EventsSerialEventHexHighlight( hexPos , true, nil, "WorkedForcedFill" )
						EventsSerialEventHexHighlight( hexPos , true, nil, "WorkedForcedOutline" )
					end
